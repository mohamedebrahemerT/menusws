                                ...
                                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar3.jpg" alt="...">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar1.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar4.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar2.jpg" alt="...">
                                            <div class="media-body">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar6.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar7.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar8.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar9.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar10.jpg" alt="...">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="media-object" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar11.jpg" alt="...">
                                            <div class="media-body">
                                ...
                                <div class="page-quick-sidebar-item">
                                    <div class="page-quick-sidebar-chat-user">
                                        ...
                                        <div class="page-quick-sidebar-chat-user-messages">
                                            <div class="post out">
                                                <img class="avatar" alt="" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar3.jpg" />
                                                <div class="message">
                                            ...
                                            <div class="post in">
                                                <img class="avatar" alt="" src="<?php echo e(url('/')); ?>/assets/layouts/layout/img/avatar2.jpg" />
                                                <div class="message">
                                                    <span class="arrow"></span>
            ...
            <div class="page-footer" style="background-color: #252B28">
                <div class="page-footer-inner"> ©️   <?php echo e(date('Y')); ?>  <?php echo e(trans('trans.all rights are save')); ?>
...
<![endif]-->
        ...
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/horizontal-timeline/horozontal-timeline.min.js" type="text/javascript"></script>
        ...
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/global/plugins/jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>
        ...
        <script src="<?php echo e(url('/')); ?>/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo e(url('/')); ?>/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
...
<script src="<?php echo e(asset('/assets/plugins/sweetalert/sweetalert.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/assets/plugins/sweetalert/jquery.sweet-alert.custom.js')); ?>"></script>
        <!-- ============================================================== -->
        <!-- Style switcher -->
        <!-- ============================================================== -->
        <script src="<?php echo e(asset('/assets/plugins/styleswitcher/jQuery.style.switcher.js')); ?>"></script>
        <script src="<?php echo e(asset('/assets/plugins/toastr/toastr.js')); ?>"></script>
 ...
 <!-- BEGIN PAGE LEVEL PLUGINS -->
        ...
        <!-- END PAGE LEVEL SCRIPTS -->
  <script src="<?php echo e(url('/')); ?>/assets/ckeditor/ckeditor/ckeditor.js"></script>

   <script src="https://cdn.datatables.net/plug-ins/1.11.3/i18n/ar.json"></script>

 
<script src="<?php echo e(url('/')); ?>/assets/jstree/dist/jstree.min.js"></script>

          <?php echo $__env->yieldPushContent('js'); ?>
    </body>
<?php /**PATH C:\xampp\htdocs\dashboard\menusws\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>