...
<head>
    ...
    <link rel="apple-touch-icon" href="{{url('landing')}}/images/logo.png">
    <link rel="apple-touch-icon" sizes="72x72" href="{{url('landing')}}/images/logo.png">

    <link rel="shortcut icon" href="https://www.pcfo.ps/home/assets/images/faviconcpal.ico" />
    <link rel="apple-touch-icon" sizes="114x114" href="{{url('landing')}}/images/faviconcpal.ico">
    <!-- END HEAD -->
    <!-- BEGIN PAGE LEVEL PLUGINS -->
